...
public final class CMSettings {
    ...
    public static final class System extends Settings.NameValueTable {
         ...
         * 4: Display the battery as a bigcircle
         * 5: Display the battery as a solid
         * 6: Display the battery as a gauge
         * 7: Hide the battery status information
         * 8: Display the battery an icon in landscape mode
         * 9: Display the battery as plain text
         * default: 0
         */
        ...
        public static final Validator STATUS_BAR_BATTERY_STYLE_VALIDATOR =
                new DiscreteValueValidator(new String[] {"0", "2", "4", "5", "6", "7", "8", "9"});
         ...
         * 12 - Screenshot (full screen)
         * 13 - Screenshot (selected region)
         */
